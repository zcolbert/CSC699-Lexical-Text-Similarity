    ...
    for (size_t i = 0; i < n; i += blocksize)
    {
        for (size_t j = 0; j < n; j += blocksize)
        {
            ...
            for (size_t k = 0; k < m; k += blocksize)
            {
                readBlock(ablock, lhs, i, k, m, blocksize);
                readBlock(bblock, rhs, k, j, n, blocksize);
                matrixMultiply_ikj(ablock, bblock, cblock, blocksize, blocksize);
            }
            writeBlock(result, cblock, i, j, n, blocksize);
        }
    }
    ...
    for (size_t i = 0; i < n; i += blocksize)
    {
        for (size_t j = 0; j < n; j += blocksize)
        {
            ...
            for (size_t k = 0; k < m; k += blocksize)
            {
                readBlock(ablock, lhs, i, k, m, blocksize);
                readBlock(bblock, rhs, k, j, n, blocksize);
                matrixMultiply_jik(ablock, bblock, cblock, blocksize, blocksize);
            }
            writeBlock(result, cblock, i, j, n, blocksize);
        }
    }
    ...
    for (size_t i = 0; i < n; i += blocksize)
    {
        for (size_t j = 0; j < n; j += blocksize)
        {
            ...
            for (size_t k = 0; k < m; k += blocksize)
            {
                readBlock(ablock, lhs, i, k, m, blocksize);
                readBlock(bblock, rhs, k, j, n, blocksize);
                matrixMultiply_jki(ablock, bblock, cblock, blocksize, blocksize);
            }
            writeBlock(result, cblock, i, j, n, blocksize);
        }
    }
